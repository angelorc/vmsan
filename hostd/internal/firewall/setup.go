...
func setupVMTable(ctx context.Context, opts *SetupOptions) error {
...
func addInterfaceForwardRules(b *rules.Builder, opts *SetupOptions) {
...
func addPolicyRules(b *rules.Builder, opts *SetupOptions) error {
	switch opts.Policy {
	case PolicyAllowAll:
		b.Accept()
	case PolicyDenyAll:
...
func addPublishedPortRules(c *nftables.Conn, table *nftables.Table, chain *nftables.Chain, opts *SetupOptions) error {
...
func addTLSDNATRules(c *nftables.Conn, table *nftables.Table, chain *nftables.Chain, opts *SetupOptions) {
...
func addHTTPDNATRules(c *nftables.Conn, table *nftables.Table, chain *nftables.Chain, opts *SetupOptions) {
...
func addDNSDNATRules(c *nftables.Conn, table *nftables.Table, chain *nftables.Chain, opts *SetupOptions) {
